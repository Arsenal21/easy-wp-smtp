							...
							<table class="form-table">
								...
								<tr valign="top">
									...
									<td>
										...
										<p class="description"><?php _e("When enabled, plugin attempts to block ALL emails from being sent out if domain mismtach.", "easy-wp-smtp"); ?></p>
									</td>
								</tr>
								<tr valign="top">
						...
						<div class="inside">
							...
							<table class="form-table">
								...
								<tr valign="top">
									...
									<td>
										<button id="swpsmtp_self_destruct_btn" style="color: red;" type="button" class="button button-secondary">>>> <?php _e('Self-destruct', 'easy-wp-smtp'); ?> <<<</button> <p class="description"><?php _e("This will remove ALL your settings and deactivate the plugin. Useful when you're uninstalling the plugin and want to completely remove all crucial data stored in the database.", 'easy-wp-smtp'); ?></p>
